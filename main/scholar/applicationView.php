         ...
         <div class="d-flex flex-column">
            <h5 class="text-dark mb-4">
               ...
               if ($status == 'pending') {
                  ...
                  echo 'now <span class="fw-bold approved"> verified</span>';
               }
               ?>
            </h5>
            ...
            <p class="text-dark">
               <?php
               if ($status == 'pending') {
                  echo 'Your scholarship application will be reviewed by the administrator. Once approved, the admin will send you the schedule of your appointment for interview.';
               } else if ($status == 'approved') {
                  echo 'Your application has been approved. You may view your schedule and the additional note from the administrator to guide you on how to process your form. <strong>Make sure to bring your requirements and be on time.</strong>';
               } else if ($status == 'rejected') {
                  echo 'Your application form has been rejected. Click the button below to identify what made your application rejected.';
               } else if ($status == 'modified') {
                  echo 'Your application form has been modified. Please wait for the administrator to review your application form again before attempting anything else.';
               } else if ($status == 'verified') {
                  echo 'Congratulations! You are now an official scholar of our institution.<br>You may review your application form below.';
               }
               ?>
            </p>
            <div class="d-flex w-50">
               <button type="button" class="btn btn-success w-50" data-bs-toggle="modal" data-bs-target="#appointment" <?php
               ...
               <button type="button" class="btn btn-warning w-50 text-light" data-bs-toggle="modal" data-bs-target="#note" <?php
      ...
      <div class="modal-dialog modal-dialog-centered">
         <div class="modal-content">
            ...
            <div class="modal-body">
               <div class="form-floating">
                  <div class="mb-3">
                     <label for="exampleFormControlInput1" class="form-label">Your schedule</label>
                     <input type="text" disabled class="form-control" id="exampleFormControlInput1" placeholder="name@example.com" value="<?php echo $row['scholar_schedule'] ?>">
                  </div>
                  <div class="mb-3">
                     <label for="exampleFormControlTextarea1" class="form-label">Notes</label>
                     <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" disabled><?php echo $row['scholar_note'] ?></textarea>
                  </div>
               </div>
            </div>
         </div>
   ...
   <div class="modal fade" id="note" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered">
         <div class="modal-content">
            ...
            <div class="modal-body">
               <div class="form-floating">
                  <textarea class="form-control" placeholder="Leave a comment here" id="schedule_input" disabled><?php if (isset($row['scholar_note'])) {
                                                                                                                     echo $row['scholar_note'];
                                                                                                                  } else {
                                                                                                                     echo 'null';
                                                                                                                  } ?></textarea>
